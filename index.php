	...
	?>
		...
		<!-- One -->
			<section id="one" class="wrapper style1 align-center">
				<div class="container">
					<header>
						<h2><b>FARM-STORE</b></h2>
						<p><b>TEAM-MEMBERS</b></p>
					</header>
					<div class="row">
						<section class="4u 12u$(small)">
							<i class="icon big rounded fa-user"></i>
							<p><b>VEERESH HIREMATH</b></p>
						</section>
						<section class="4u 12u$(small)">
							<i class="icon big rounded fa-user"></i>
							<p><b>UROOJAKTHAR KHAN</b></p>
						</section>
		...
		<div class="footer-left">
			<h3 style="font-family: 'Times New Roman', cursive;">FARM-STORE &copy; </h3>
		<!--	<div class="logo">
				<a href="index.php"><img src="images/logo.png" width="200px"></a>
			</div>-->
			<br />
			<p style="font-size:20px;color:white"><b>ALL-YOUR-NEEDS</b></p>
			<br />
		</div>
		...
		<div class="footer-center">
			<div>
				...
				<p style="font-size:20px">FARM-STORE<span>DRMSSCET-BELGAUM</span></p>
			</div>
			<div>
			...
			<div>
				...
				<p style="font-size:20px"><a href="mailto:agroculture@gmail.com" style="color:white">chandengineer27@gmail.com</a></p>
			</div>
		</div>

		<div class="footer-right">
			<p class="footer-company-about" style="color:white">
				<span style="font-size:20px"><b>About FARM-STORE</b></span>
				<b>Farm’ is a modified piece of land held or operated as a unit for the production of agricultural products.</b>
			</p>
